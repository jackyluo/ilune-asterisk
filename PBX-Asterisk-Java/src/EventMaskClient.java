...
import cn.ilune.asteriskjava.manager.action.EventsAction;
...
public static void main(String[] args) throws Exception {
		...
		EventsAction ea = new EventsAction();
		//ea.setActionId("testEventMask");
		//���������¼�
		//ea.setEventMask("on");
		...
		ManagerResponse resp0 = dmc.sendAction(ea);		
		System.out.println("EventsAction resp="+resp0);
