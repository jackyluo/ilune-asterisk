...
public class BlindTransferActionClient {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 * 
		 */
		action.setChannel("SIP/810-0000004a");
		//actionId �������
		action.setActionId("BNDFER-");
		...
		System.out.println("BlindTransferAction resp=" + resp);
		conn.logoff();
	}
}
